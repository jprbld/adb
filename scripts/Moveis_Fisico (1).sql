...
VALUES ('Sheila Tuna Espírito Santo', '48936331043','Avenida São João', 'Vila Joana', '13216000', 0.1, 'Jundiai'),
	   ('Marcelo Frois Caminha', '25964866018', 'Rua Paracatu', 'Parque Imperial', '04302021', 0.1, 'São Paulo'),
	   ('Alice Barbalho Vilalobos', '33474720040', 'Rua Cristiano Olsen', 'Jardim Sumaré', '16015244', 0.1, 'Araçatuba'),
	   ('Abigail Barateiro Cangueiro', '56069215028', 'Rua Serra de Bragança', 'Vila Gomes Cardim', '03318000', 0.1, 'São Paulo')
...
INSERT INTO Cliente
VALUES ('Derek Bicudo Lagos', '91039176062', 'Rua Barão de Vitória', 'Casa Grande', 'Diadema', '09961660'),
	   ('Jaime Câmara Valério', '02889437086', 'Rua Pereira Estéfano', 'Vila da Saúde', 'São Paulo', '04144070'),
	   ('Abel da Costa Azambuja', '02534695037', 'Avenida Tocantins', 'Vila Jardim Rio Claro', 'Jataí', '75802095'),
	   ('Zion Pedro Simões', '97450732025', 'Rua Domingos Olímpio', 'Centro', 'Sobral', '62011140'),
	   ('Xavier Doutis Negromonte', '02364136008', 'Avenida Afonso Pena', 'Boa Viagem', 'Belo Horizonte', '30130005'),
	   ('Sofia Figueiroa Brum', '61295251094', 'Travessa Antônio Ferreira', 'Igrejinha', 'Capanema', '68700216')
...
VALUES ('Jason Carmo Teves', '06145434500'),
	   ...
	   ('Luísa Viana Bonito', '13576973505'),
	   ('Kevin Marmou Afonso', '67848316264'),
	   ('Cátia Tristão Frajuca', '53799919545')
...
SELECT V.nome,
	   ...
	   Venda.numero,
	   Venda.serie,
	   CONVERT(VARCHAR, Venda.dataEmissao, 103) AS [Data de emissão],
	   FORMAT(SUM(Venda.valorTotal), 'C', 'pt-br') AS [Valor Total],
	   FORMAT(SUM(Venda.valorTotal) * V.porcentagem, 'C', 'pt-br') AS Comissão    
FROM Vendedor AS V
INNER JOIN Venda ON V.codigo = Venda.vendedorCodigo
INNER JOIN ItemVenda AS Item ON Venda.numero = Item.vendaNumero AND Venda.serie = Item.vendaSerie
...
---> Consultas (com variações de JOINs)
...
VALUES ('Clarisse Barrela Parafita', '47249240048','Avenida São Jorge', 'São Francisco', '58950-998', 0.15, 'Itaguaí'),
...
SELECT V.nome,
	   ...
	   CONVERT(VARCHAR, Venda.dataEmissao, 103) AS [Data de emissão],
	   P.descricao AS Produto,
	   FORMAT(Item.valorItem, 'C', 'pt-br') AS [Valor unitário vendido],
	   Item.quantidade,
...
-- Todos os vendedores independentemente de terem realizado vendas ou não
SELECT V.nome,
	   FORMAT(V.porcentagem, 'P') AS Porcentagem,	
	   Venda.numero,
	   Venda.serie,
...
-- Somente os vendedores que não realizaram vendas
SELECT V.nome,
	   FORMAT(V.porcentagem, 'P') AS Porcentagem,	
	   Venda.numero,
	   Venda.serie,
...
-- Todos os vendedores e produtos independenetemente de terem sido vendidos ou não
SELECT V.nome,
	   FORMAT(V.porcentagem, 'P') AS Porcentagem,	
	   Venda.numero,
	   Venda.serie,
...
-- Somente os vendedores que não realizaram vendas e os produtos que não forma vendidos
SELECT V.nome,
	   FORMAT(V.porcentagem, 'P') AS Porcentagem,	
	   Venda.numero,
	   Venda.serie,
