...
INSERT INTO Cliente -- nome, cpf, logradouro, bairro, cidade, uf, cep
VALUES ('Derek Bicudo Lagos', '91039176062', 'Rua Barao de Vitoria, 987', 'Casa Grande', 'Diadema', 'SP', '09961660'),
	   ('Jaime Camara Valario', '02889437086', 'Rua Pereira Estefano, 654', 'Vila da Saude', 'Sao Paulo', 'SP', '04144070'),
	   ('Abel da Costa Azambuja', '02534695037', 'Avenida Tocantins, 321', 'Vila Jardim Rio Claro', 'Jatai', 'GO', '75802095'),
	   ('Zion Pedro Simoes', '97450732025', 'Rua Domingos Olimpio, 741', 'Centro', 'Sobral', 'CE', '62011140'),
	   ('Xavier Doutis Negromonte', '02364136008', 'Avenida Afonso Pena, 852', 'Boa Viagem', 'Belo Horizonte', 'MG', '30130005'),
	   ('Sofia Figueiroa Brum', '61295251094', 'Travessa Antonio Ferreira, 963', 'Igrejinha', 'Capanema', 'PR', '68700216')

SELECT * FROM Cliente	


INSERT INTO Vendedor -- nome, cpf, logradouro, bairro, cidade, uf, cep, porcentagem
VALUES ('Sheila Tuna Esp�rito Santo', '48936331043','Avenida Sao Joao, 123', 'Vila Joana', 'Jundiai', 'SP', '13216000', 0.1),
	   ('Marcelo Frois Caminha', '25964866018', 'Rua Paracatu, 456', 'Parque Imperial','Sao Paulo', 'SP', '04302021',  0.15),
	   ('Alice Barbalho Vilalobos', '33474720040', 'Rua Cristiano Olsen, 789', 'Jardim Sumaru', 'Aracatuba', 'SP', '16015244', 0.2),
	   ('Abigail Barateiro Cangueiro', '56069215028', 'Rua Serra de Braganca, 159', 'Vila Gomes Cardim', 'Sao Paulo', 'SP', '03318000', 0.15)
...
INSERT INTO Tratamento -- descricao, acrescimo
...
INSERT INTO Produto -- descricao, tratamentoCodigo, precoCusto, precoVenda
...
INSERT INTO Motorista -- nome, cnh
VALUES ('Jason Carmo Teves', '06145434500'),
	   ...
	   ('Catia Tristao Frajuca', '53799919545')
...
INSERT INTO Venda -- numero, serie, clienteCodigo, vendedorCodigo, dataEmissao, valorTotal
VALUES (1, 100, 2, 4, '02/01/2022', 1495.00),
	   (2, 100, 1, 2, '02/01/2022', 3450.00),
	   (3, 100, 6, 1, '03/01/2022', 2450.00),
	   (4, 100, 4, 3, '03/01/2022', 1610.00),
	   (5, 100, 2, 4, '03/01/2022', 3140.00),
	   (1, 101, 1, 4, '04/01/2022', 3450.00),
	   (2, 101, 4, 2, '04/01/2022', 1555.00),
	   (3, 101, 2, 1, '04/01/2022', 1380.00)
SELECT * FROM Venda

INSERT INTO ItemVenda -- vendaNumero, vendaSerie, produtoCodigo, quantidade, valorItem
VALUES (1, 100, 2, 1, 805.00),
	   ...
	   (2, 101, 4, 1, 690.00),
	   (3, 101, 4, 2, 1380.00)
-- Obs.: Alguns pre�os diferentes dos pre�os de vendo dos produtos
SELECT * FROM ItemVenda


INSERT INTO Entrega -- vendaNumero, vendaSerie, motoristaCodigo
VALUES (1, 100, 2),
	   (2, 100, 3),
	   (3, 100, 1),
	   (3, 100, 4),
...
INSERT INTO Vendedor -- nome, cpf, logradouro, bairro, cidade, uf, cep, porcentagem, 
VALUES ('Clarisse Barrela Parafita', '47249240048','Avenida Sao Jorge', 'Sao Francisco', 'Itaguai', 'RJ', '58950-998', 0.15),
	   ('Valentino Vasques Mascarenhas', '83382690004', 'Rua Mato Grosso', 'Boa Vista', 'Parintinso', 'AM', '79298-291', 0.1)
...
-- Todos os vendedores e produtos independentemente de terem sido vendidos ou n�o
SELECT V.nome,
	   FORMAT(V.porcentagem, 'P') AS Porcentagem,	
	   Venda.numero,
	   Venda.serie,
...
--> Consultas de Produto e Tratamento (varia��es de JOIN)
...
-- 02. Consulte todos os produtos independentemente se receberam tratamento ou n�o
SELECT P.descricao,
	   P.tratamentoCodigo,
	   T.codigo,
	   T.descricao
FROM Produto AS P
LEFT JOIN Tratamento AS T ON P.tratamentoCodigo = T.codigo
ORDER BY P.codigo


-- 03. Consulte somente os produtos que n�o receberam tratamento
SELECT P.descricao,
	   P.tratamentoCodigo,
	   T.codigo,
	   T.descricao
...
-- 04. Consulte todos os tratamentos independentemente de terem sido aplicados ou n�o
SELECT P.descricao,
	   P.tratamentoCodigo,
	   T.codigo,
	   T.descricao
FROM Produto AS P
RIGHT JOIN Tratamento AS T ON P.tratamentoCodigo = T.codigo
ORDER BY P.codigo
...
SELECT P.descricao,
	   ...
	   T.descricao
FROM Produto AS P
FULL JOIN Tratamento AS T ON P.tratamentoCodigo = T.codigo
ORDER BY P.codigo


-- 07. Consulte somente os produto que n�o foram tratados e os tratamentos que n�o foram aplicados
SELECT P.descricao,
	   P.tratamentoCodigo,
	   T.codigo,
	   T.descricao
FROM Produto AS P
FULL JOIN Tratamento AS T ON P.tratamentoCodigo = T.codigo
WHERE P.tratamentoCodigo IS NULL OR T.codigo IS NULL
ORDER BY P.codigo
...
-- Consulte as vendas (e seus itens) em que foram aplicados descontos ou acr�scimos 
-- (em rela��o ao pre�o de venda do produto) emitidas no dia 03/01/2022, para tanto:
/*
	1. Obtenha as vendas (informa��es necess�rias) realizadas nesse dia
	2. Armazene essas insforma��es em uma tabela tempor�ria chamada #VendasPeriodo
	3. Compare os valores totais por item das vendas com os totais baseados nos pre�os de venda dos produtos
	   3.1. Calcule a diferen�a entre esses valores
	4. Consulte as vendas que possuem itens com pre�os diferentes dos produtos 
	   (as vendas devem conter todos os itens independentemente da diren�a nos pre�os) 
	5. Obter os valores totais das vendas que foram realizadas e 
	   os valores totais dessas vendas considerando o pre�o de venda do produto
	6. Identifique cada item das vendas com as descri��es: Acr�scimo, Desconto ou Valores iguais
	7. Declare uma vari�vel de tabela nomeada @VendasValoresDivergentes, com os seguintes campos:
	   Codigo (INT IDENTITY), NotaFiscal (Numero+Serie+DataEmissao),	Produto, Quantidade, ValorItem,	ValorProduto,
	  Diferencas, Descricao (Acr�scimo, Desconto ou Valores iguais), TotalVenda, TotalDiferenca
	8. Armazene os dados gerados e/ou transformados em @VendasValoresDivergentes
	9. Apresentar (com as devidas formata��es) os campos e valores da tabela VendasValoresDivergentes na seguinte ordem:
	   NotaFiscal, Produto, Quantidade, ValorItem, ValorProduto, ValorDiferen�as, Descri��o, 
	   Valor Total da NF e Valor Total da diferen�as (por NF)
*/
